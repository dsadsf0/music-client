...
const PlusButton = memo(({ className, onClick, }: Props) => {
    ...
    >
      <svg x="0px" y="0px" viewBox="0 0 210.414 210.414">
        ...
        <path d="M155.862,101.31h-46.759V54.552c0-2.152-1.745-3.897-3.897-3.897s-3.897,1.745-3.897,3.897v46.759H54.552
				...
				s3.897-1.745,3.897-3.897v-46.759h46.759c2.152,0,3.897-1.745,3.897-3.897C159.759,103.055,158.014,101.31,155.862,101.31z" fill="currentColor"/>
      </svg>
    </button>
  )
})
